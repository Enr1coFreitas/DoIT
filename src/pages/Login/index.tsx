import { Flex, Grid, Heading, Image, Text, Input, VStack } from "@chakra-ui/react";
...
color="white">
    <Flex w="100%" justifyContent="center" flexDirection="row" alignItems="center">
        ...
        <Grid as="form" mt="4" w="100%" padding="30px 15px" border="3px solid" borderColor="gray.100" bg="white" color="gray.900">
